;;; dracula-light-theme.el --- Dracula Light Theme

;; Copyright 2015-present, All rights reserved
;;
;; Code licensed under the MIT license

;; Maintainer: Edd Wilder-James <ewilderjames@gmail.com>
;; Author: film42 (ported by Gemini)
;; Version: 1.8.2
...
;; A light color theme based on Dracula.
...
(defgroup dracula-light nil
  "Dracula Light theme options.

The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom dracula-light-enlarge-headings t
  "Use different font sizes for some headings and titles."
  :type 'boolean
  :group 'dracula-light)

(defcustom dracula-light-height-title-1 1.3
  "Font size 130%."
  :type 'number
  :group 'dracula-light)

(defcustom dracula-light-height-title-2 1.1
  "Font size 110%."
  :type 'number
  :group 'dracula-light)

(defcustom dracula-light-height-title-3 1.0
  "Font size 100%."
  :type 'number
  :group 'dracula-light)

(defcustom dracula-light-height-doc-title 1.44
  "Font size 144%."
  :type 'number
  :group 'dracula-light)
...
(let ((colors `(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               (menu :background ,dracula-current :inverse-video nil
                     ,@(if dracula-light-alternate-mode-line-and-minibuffer
                           (list :foreground fg3)
               ...
               (elpher-gemini-heading1 :inherit bold :foreground ,dracula-pink
                                       ,@(when dracula-light-enlarge-headings
                                           (list :height dracula-light-height-title-1)))
               (elpher-gemini-heading2 :inherit bold :foreground ,dracula-purple
                                       ,@(when dracula-light-enlarge-headings
                                           (list :height dracula-light-height-title-2)))
               (elpher-gemini-heading3 :weight normal :foreground ,dracula-green
                                       ,@(when dracula-light-enlarge-headings
                                           (list :height dracula-light-height-title-3)))
               ...
               (org-document-title :weight bold :foreground ,dracula-orange
                                   ,@(when dracula-light-enlarge-headings
                                       (list :height dracula-light-height-doc-title)))
